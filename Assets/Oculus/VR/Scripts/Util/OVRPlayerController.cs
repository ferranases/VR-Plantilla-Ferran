        ...
        if (EnableRotation)
        {
            ...
            if (SnapRotation)
            {
                ...
                if (OVRInput.Get(OVRInput.Button.SecondaryThumbstickLeft) ||
                    (RotationEitherThumbstick && OVRInput.Get(OVRInput.Button.PrimaryThumbstickLeft, OVRInput.Controller.RTouch)))
                {
                    if (ReadyToSnapTurn)
                    {
                        euler.y -= RotationRatchet;
                    ...
                    (RotationEitherThumbstick && OVRInput.Get(OVRInput.Button.PrimaryThumbstickRight, OVRInput.Controller.RTouch)))
                {
                    if (ReadyToSnapTurn)
                    {
                        euler.y += RotationRatchet;
